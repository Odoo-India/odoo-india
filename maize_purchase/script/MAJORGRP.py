...
class Parser(object):
    ...
    def import_postcode(self, lines):
        ...
        postal_pool = connection.get_model("product.major.group")
#        fiscalyear_pool = connection.get_model("account.fiscalyear")
        ...
        print "Major Group import successfully",p, r, warning, s
...
def main():
    ...
    try:
        ...
        data_lines = read_csv_data(root_path + "MAJORGRP.csv")
