...
class Parser(object):
    ...
    def import_postcode(self, lines):
        ...
        postal_pool = connection.get_model("stock.location")
#        fiscalyear_pool = connection.get_model("account.fiscalyear")
        ...
        print "Department Master import successfully",p, r, warning, s
...
def main():
    ...
    try:
        ...
        data_lines = read_csv_data(root_path + "DEPTMST.csv")
