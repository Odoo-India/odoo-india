...
class account_month_invoice(osv.osv_memory):
    ...
    """
    _name = "account.tds.form27ann"
    _description = "27 Annual Annexure"
    _columns = {
       'date_start': fields.date('Start Date'),                        
       'date_end': fields.date('End Date'),
              'name_id':fields.many2one("account.tds.deductor","Name of Deductor",required=True),     
    ...
    def account_tds_report(self, cr, uid, ids, data={},context=None):            
        ...
        return {'type': 'ir.actions.report.xml', 'report_name': 'account.tds.form27_annexure','datas':data}
