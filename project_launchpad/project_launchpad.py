...
class project_branch(osv.osv):
    ...
    _track = {
        'state': {
            'project.mt_branch_new': lambda self, cr, uid, obj, ctx=None: obj['state'] in ['Development', 'Mature', 'Merged', 'Abandoned', 'Experimental'],
            'project.development': lambda self, cr, uid, obj, ctx=None: obj['state'] == 'Development',
            'project.mature': lambda self, cr, uid, obj, ctx=None: obj['state'] == 'Mature',
            'project.merged': lambda self, cr, uid, obj, ctx=None: obj['state'] == 'Merged',
            'project.adandoned': lambda self, cr, uid, obj, ctx=None: obj['state'] == 'Abandoned',
            'project.experimental': lambda self, cr, uid, obj, ctx=None: obj['state'] == 'Experimental',
            'project.new_branch': lambda self, cr, uid, obj, ctx=None: obj['branch_type'] in ['fix', 'feature', 'improvement', 'removed']
        },
    }
