...
#        'out_inspector_id': fields.many2one('res.users','Out Inspector', required=True),
        ...
        'state':fields.selection([('draft','Draft'), ('observation','Observation'), ('inprogress','Need Equipment'), ('repair','Repair In Progress'), ('done','Done'), ('inspection','Inspection'), ('cancel','Cancel'), ('delivered','Delivered')],'State',readonly=True)
    }
