...
class DefaultConfig(object):
    ...
    OPENERP_PORT = 8069
    OPENERP_DEFAULT_DATABASE = 'test26'
    PATH = False
...
class Parser(object):
    ...
    def import_postcode(self, lines):
        ...
        postal_pool = connection.get_model("account.analytic.account")
#        fiscalyear_pool = connection.get_model("account.fiscalyear")
        ...
        print "Analytic Account(project master) Import sucessfully",p, r, warning, s
...
def main():
    ...
    try:
        ...
        data_lines = read_csv_data(root_path + "PROJMAS.csv")
