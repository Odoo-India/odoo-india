...
class DefaultConfig(object):
    ...
    OPENERP_PORT = 8069
    OPENERP_DEFAULT_DATABASE = 'test1'
    PATH = False
...
class Parser(object):
    ...
    def import_postcode(self, lines):
        ...
        postal_pool = connection.get_model("res.country.state")
#        fiscalyear_pool = connection.get_model("account.fiscalyear")
        ...
        print "State Import sucessfully",p, r, warning, s
...
def main():
    ...
    try:
        ...
        data_lines = read_csv_data(root_path + "ALL_Indian_States.csv")
