...
report_sxw.report_sxw('report.account.tds.form27_annexure', 'account.account',
'addons/account_tds_report/report/tds_report_form27_annual_annexure.rml', parser=order, header=True)
