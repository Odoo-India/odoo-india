...
class stock_picking_receipt(osv.Model):
    ...
    _columns = {
        ...
        'amount_total': fields.function(_total_amount, multi="cal", type="float", string='Total', store=True, digits_compute=dp.get_precision('Stock Picking Receipt')),
        'total_diff': fields.function(_total_amount, multi="cal", type="float", string='Total Diff', help="Total Diff", store=True, digits_compute=dp.get_precision('Stock Picking Receipt')),
        'amount_subtotal': fields.function(_total_amount, multi="cal", type="float", string='Total Amount', help="Total Amount(computed as (Total - Total Diff))", store=True, digits_compute=dp.get_precision('Stock Picking Receipt')),
        ...
        'import_duty': fields.function(_total_amount, multi="cal", type="float", string='Import Duty', help="Total Import Duty", store=True, digits_compute=dp.get_precision('Stock Picking Receipt')),
        'voucher_id': fields.many2one('account.voucher', 'Payment'),
