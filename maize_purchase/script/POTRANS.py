...
def get_field_mapping(conn, values, mapping):
    ...
    data_lst.append('Unit(s)')
    fields.append('name')
    data_lst.append('Unit(s)')
    fields.append('date_planned')
    data_lst.append('2012-01-01')
...
class Parser(object):
    ...
    def import_postcode(self, lines):
        ...
        postal_pool = connection.get_model("purchase.order.line")
...
def main():
    ...
    try:
        ...
        data_lines = read_csv_data(root_path + "POTRANS.csv")
