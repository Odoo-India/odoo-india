...
class account_month_invoice(osv.osv_memory):
    ...
    def account_tds_report(self, cr, uid, ids, data={},context=None):            
        print "data=",data
        data['form']={}
        data['form'].update(self.read(cr, uid, ids, ['date_start','date_end'], context=context)[0])
        #data = self.pre_print_report(cr, uid, ids, data, context=context)
        return {'type': 'ir.actions.report.xml', 'report_name': 'account.tds.computation','datas':data}
