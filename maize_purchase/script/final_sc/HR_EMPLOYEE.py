...
class Parser(object):
    ...
    def import_postcode(self, lines):
        ...
        postal_pool = connection.get_model("hr.employee")
#        fiscalyear_pool = connection.get_model("account.fiscalyear")
        ...
        print "EMPLOYEE related to INDENTOR are import successfully",p, r, warning, s
...
def main():
    ...
    try:
        ...
        data_lines = read_csv_data(root_path + "HR_EMPLOYEE.csv")
