...
report_sxw.report_sxw('report.account.tds.form26ann', 'account.account',
'addons/account_tds_report/report/tds_report_form26_annual_annex.rml', parser=order, header=True)
