...
class import_indent_data_line(osv.osv_memory):
    ...
    def do_import_indent_data_line(self, cr, uid,ids, context=None):
        ...
        file_path = "/home/maize/data/8_aug/indent_line_upto_8_aug.csv"
...
# "product_uom": "ITEMCODE",
        ...
        for data in data_lines:
            ...
            try:
                indent = indent_pool.search(cr,uid,['|',('maize','=', fiscalyear+'/'+data["INDENTNO"].strip()),('name','=', fiscalyear+'/'+data["INDENTNO"].strip())])[0]
